...
export const TOOLS:{status:ToolStatus;title:string;body:string;href:string;game:string}[]=[
  ...
  {status:'live',title:'Corporate Clash Gag Calculator',body:'Calculate gag damage combos against any cog level, toggle prestige and lure bonuses, and plan your perfect gag track build.',href:'/cc-gag-calculator',game:'Toontown: Corporate Clash'},
