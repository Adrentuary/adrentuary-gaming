...
const TOON_UP: CCGagTrack = {
  ...
  gags: [
    { name: 'Feather',         damage: 0, heal: 12,  icon: 'Feather.webp',         level: 1 },
    { name: 'Megaphone',       damage: 0, heal: 24,  icon: 'Megaphone.webp',       level: 2 },
    { name: 'Lipstick',        damage: 0, heal: 30,  icon: 'Lipstick.webp',        level: 3 },
    { name: 'Bamboo Cane',     damage: 0, heal: 45,  icon: 'Bamboo Cane.webp',     level: 4 },
    { name: 'Pixie Dust',      damage: 0, heal: 60,  icon: 'Pixie Dust.webp',      level: 5 },
    { name: 'Juggling Cubes',  damage: 0, heal: 90,  icon: 'Juggling Cubes.webp',  level: 6 },
    { name: 'Confetti Cannon', damage: 0, heal: 95,  icon: 'Confetti Cannon.webp', level: 7 },
    { name: 'High Dive',       damage: 0, heal: 135, icon: 'High Dive.webp',       level: 8 },
  ],
};
...
const TRAP: CCGagTrack = {
  ...
  gags: [
    { name: 'Banana Peel',   damage: 16,  icon: 'Banana Peel.webp',   level: 1 },
    { name: 'Rake',          damage: 32,  icon: 'Rake.webp',           level: 2 },
    { name: 'Springboard',   damage: 50,  icon: 'Springboard.webp',    level: 3 },
    { name: 'Marbles',       damage: 80,  icon: 'Marbles.webp',        level: 4 },
    { name: 'Quicksand',     damage: 120, icon: 'Quicksand.webp',      level: 5 },
    { name: 'Trapdoor',      damage: 170, icon: 'Trapdoor.webp',       level: 6 },
    { name: 'Wrecking Ball', damage: 230, icon: 'Wrecking Ball.webp',  level: 7 },
    { name: 'TNT',           damage: 290, icon: 'TNT.webp',            level: 8 },
  ],
};
...
const LURE: CCGagTrack = {
  ...
  gags: [
    { name: '$1 Bill',       damage: 0, icon: '$1 Bill.webp',       level: 1 },
    { name: 'Small Magnet',  damage: 0, icon: 'Small Magnet.webp',  level: 2 },
    { name: '$5 Bill',       damage: 0, icon: '$5 Bill.webp',       level: 3 },
    { name: 'Big Magnet',    damage: 0, icon: 'Big Magnet.webp',    level: 4 },
    { name: '$10 Bill',      damage: 0, icon: '$10 Bill.webp',      level: 5 },
    { name: 'Hypno-goggles', damage: 0, icon: 'Hypno-goggles.webp', level: 6 },
    { name: '$50 Bill',      damage: 0, icon: '$50 Bill.webp',      level: 7 },
    { name: 'Presentation',  damage: 0, icon: 'Presentation.webp',  level: 8 },
  ],
};
...
const THROW: CCGagTrack = {
  ...
  gags: [
    { name: 'Cupcake',             damage: 8,   icon: 'Cupcake.webp',             level: 1 },
    { name: 'Fruit Pie Slice',     damage: 13,  icon: 'Fruit Pie Slice.webp',     level: 2 },
    { name: 'Cream Pie Slice',     damage: 20,  icon: 'Cream Pie Slice.webp',     level: 3 },
    { name: 'Birthday Cake Slice', damage: 35,  icon: 'Birthday Cake Slice.webp', level: 4 },
    { name: 'Whole Fruit Pie',     damage: 56,  icon: 'Whole Fruit Pie.webp',     level: 5 },
    { name: 'Whole Cream Pie',     damage: 90,  icon: 'Whole Cream Pie.webp',     level: 6 },
    { name: 'Birthday Cake',       damage: 130, icon: 'Birthday Cake.webp',       level: 7 },
    { name: 'Wedding Cake',        damage: 170, icon: 'Wedding Cake.webp',        level: 8 },
  ],
};
...
const SQUIRT: CCGagTrack = {
  ...
  gags: [
    { name: 'Squirting Flower', damage: 4,   icon: 'Squirting Flower.webp', level: 1 },
    { name: 'Glass of Water',   damage: 8,   icon: 'Glass of Water.webp',   level: 2 },
    { name: 'Squirt Gun',       damage: 12,  icon: 'Squirt Gun.webp',       level: 3 },
    { name: 'Water Balloon',    damage: 21,  icon: 'Water Balloon.webp',    level: 4 },
    { name: 'Seltzer Bottle',   damage: 30,  icon: 'Seltzer Bottle.webp',   level: 5 },
    { name: 'Fire Hose',        damage: 60,  icon: 'Fire Hose.webp',        level: 6 },
    { name: 'Storm Cloud',      damage: 90,  icon: 'Storm Cloud.webp',      level: 7 },
    { name: 'Geyser',           damage: 120, icon: 'Geyser.webp',           level: 8 },
  ],
};
...
const ZAP: CCGagTrack = {
  ...
  gags: [
    { name: 'Joybuzzer',         damage: 12,  icon: 'Joybuzzer.webp',         level: 1 },
    { name: 'Lightbulb',         damage: 20,  icon: 'Lightbulb.webp',         level: 2 },
    { name: 'Broken Radio',      damage: 36,  icon: 'Broken Radio.webp',      level: 3 },
    { name: 'Kart Battery',      damage: 60,  icon: 'Kart Battery.webp',      level: 4 },
    { name: 'Broken Television', damage: 90,  icon: 'Broken Television.webp', level: 5 },
    { name: 'Stagelight',        damage: 140, icon: 'Stagelight.webp',        level: 6 },
    { name: 'Tesla Coil',        damage: 190, icon: 'Tesla Coil.webp',        level: 7 },
    { name: 'Lightning',         damage: 240, icon: 'Lightning.webp',         level: 8 },
  ],
};
...
const SOUND: CCGagTrack = {
  ...
  gags: [
    { name: 'Kazoo',          damage: 5,  icon: 'Kazoo.webp',          level: 1 },
    { name: 'Bike Horn',      damage: 10, icon: 'Bike Horn.webp',      level: 2 },
    { name: 'Whistle',        damage: 16, icon: 'Whistle.webp',        level: 3 },
    { name: 'Bugle',          damage: 23, icon: 'Bugle.webp',          level: 4 },
    { name: 'Aoogah',         damage: 30, icon: 'Aoogah.webp',         level: 5 },
    { name: 'Elephant Trunk', damage: 50, icon: 'Elephant Trunk.webp', level: 6 },
    { name: 'Foghorn',        damage: 70, icon: 'Foghorn.webp',        level: 7 },
    { name: 'Opera Singer',   damage: 90, icon: 'Opera Singer.webp',   level: 8 },
  ],
};
...
const DROP: CCGagTrack = {
  ...
  gags: [
    { name: 'Flower Pot',   damage: 12,  icon: 'Flower Pot.webp',   level: 1 },
    { name: 'Sandbag',      damage: 20,  icon: 'Sandbag.webp',      level: 2 },
    { name: 'Bowling Ball', damage: 35,  icon: 'Bowling Ball.webp',  level: 3 },
    { name: 'Anvil',        damage: 56,  icon: 'Anvil.webp',         level: 4 },
    { name: 'Big Weight',   damage: 90,  icon: 'Big Weight.webp',    level: 5 },
    { name: 'Safe',         damage: 140, icon: 'Safe.webp',          level: 6 },
    { name: 'Boulder',      damage: 200, icon: 'Boulder.webp',       level: 7 },
    { name: 'Grand Piano',  damage: 250, icon: 'Grand Piano.webp',   level: 8 },
  ],
};
...
export const IOU_DATA: IouOption[] = [
  ...
  { key: 'rain',            toon: 'Rain',           track: 'rain',    bonus: 20,  uses: 1, icon: 'rain.webp' },
  // Toon-Up (+heal)
  { key: 'madam-chuckle',   toon: 'Madam Chuckle',  track: 'toon-up', bonus: 25,  uses: 3, icon: 'madam-chuckle.webp' },
  { key: 'daffy-don',       toon: 'Daffy Don',       track: 'toon-up', bonus: 40,  uses: 2, icon: 'daffy-don.webp' },
  { key: 'flippy',          toon: 'Flippy',          track: 'toon-up', bonus: 70,  uses: 1, icon: 'flippy.webp' },
  // Trap (+damage)
  { key: 'will',            toon: 'Will',            track: 'trap',    bonus: 70,  uses: 3, icon: 'will.webp' },
  { key: 'penny',           toon: 'Penny',           track: 'trap',    bonus: 100, uses: 2, icon: 'penny.webp' },
  { key: 'clara',           toon: 'Clara',           track: 'trap',    bonus: 170, uses: 1, icon: 'clara.webp' },
  // Lure (+knockback)
  { key: 'stinky-ned',      toon: 'Stinky Ned',      track: 'lure',    bonus: 20,  uses: 3, icon: 'stinky-ned.webp' },
  { key: 'nancy-gas',       toon: 'Nancy Gas',       track: 'lure',    bonus: 30,  uses: 2, icon: 'nancy-gas.webp' },
  { key: 'lil-oldman',      toon: "Lil' Oldman",     track: 'lure',    bonus: 40,  uses: 1, icon: 'lil-oldman.webp' },
  // Throw (+damage)
  { key: 'cleff',           toon: 'Cleff',           track: 'throw',   bonus: 30,  uses: 3, icon: 'cleff.webp' },
  { key: 'cindy-sprinkles', toon: 'Cindy Sprinkles', track: 'throw',   bonus: 45,  uses: 2, icon: 'cindy-sprinkles.webp' },
  { key: 'pierce',          toon: 'Pierce',          track: 'throw',   bonus: 80,  uses: 1, icon: 'pierce.webp' },
  // Squirt (+damage; applies to splash too per wiki)
  { key: 'sid-squid',       toon: 'Sid Squid',       track: 'squirt',  bonus: 15,  uses: 3, icon: 'sid-squid.webp' },
  { key: 'sanjay-splash',   toon: 'Sanjay Splash',   track: 'squirt',  bonus: 25,  uses: 2, icon: 'sanjay-splash.webp' },
  { key: 'sharky-jones',    toon: 'Sharky Jones',    track: 'squirt',  bonus: 40,  uses: 1, icon: 'sharky-jones.webp' },
  // Zap (+damage per target, including jumps)
  { key: 'dentist-daniel',  toon: 'Dentist Daniel',  track: 'zap',     bonus: 25,  uses: 3, icon: 'dentist-daniel.webp' },
  { key: 'electra-eel',     toon: 'Electra Eel',     track: 'zap',     bonus: 40,  uses: 2, icon: 'electra-eel.webp' },
  { key: 'nat',             toon: 'Nat',             track: 'zap',     bonus: 65,  uses: 1, icon: 'nat.webp' },
  // Sound (+damage, hits all cogs)
  { key: 'barbara-seville', toon: 'Barbara Seville', track: 'sound',   bonus: 15,  uses: 3, icon: 'barbara-seville.webp' },
  { key: 'sid-sonata',      toon: 'Sid Sonata',      track: 'sound',   bonus: 20,  uses: 2, icon: 'sid-sonata.webp' },
  { key: 'moe-zart',        toon: 'Moe Zart',        track: 'sound',   bonus: 35,  uses: 1, icon: 'moe-zart.webp' },
  // Drop (+damage)
  { key: 'clumsy-ned',      toon: 'Clumsy Ned',      track: 'drop',    bonus: 35,  uses: 3, icon: 'clumsy-ned.webp' },
  { key: 'franz-neckvein',  toon: 'Franz Neckvein',  track: 'drop',    bonus: 45,  uses: 2, icon: 'franz-neckvein.webp' },
  { key: 'barnacle-bessie', toon: 'Barnacle Bessie', track: 'drop',    bonus: 80,  uses: 1, icon: 'barnacle-bessie.webp' },
];
