...
export const DG: QuestPlayground = {
  name: 'Daffodil Gardens', icon: '🌸', pgKey: 'DG', color: '#314600', accent: '#9bd31a',
  rows: [
    H('Main Storyline'),
    ...
    KL('2→3  Ant Stop Me Now','15% Cheaper Gags in DC | +1 DC G.U.M.B.A.L.L. Booster'),
    ...
    KL('5→6  Floral Fisticuffs','30% Cheaper Gags in DG | +1 DG G.U.M.B.A.L.L. Booster'),
    KH('6→7  Top-Notch Tuft Toons','+2 DG Gag XP Multiplier'),
    KH('7→8  Quaking and Breaking','⭐ Calligraphy – Nametag Font'),
    KH('8→9  Miss-ting Mail','50% Cheaper Gags in DG | +1 DG G.U.M.B.A.L.L. Booster'),
