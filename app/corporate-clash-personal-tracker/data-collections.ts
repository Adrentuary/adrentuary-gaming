...
export const COLLECTIONS: CollectionSection[] = [
  ...
  { name:"Acorn Acres", icon:"🌰", color:"#00451e", accent:"#20cf69", items:[
    ...
    I("Arrogant","Nametag","Awarded after completing an Acorn Acres task"),
    I("Practical","Nametag","Awarded after completing an Acorn Acres task"),
  ...
  { name:"Drowsy Dreamland", icon:"💤", color:"#1a1060", accent:"#7b68ee", items:[
    ...
    I("Action","Nametag","Awarded after completing a Drowsy Dreamland task"),
    I("Cinema","Nametag","Awarded after completing a Drowsy Dreamland task"),
    I("Western","Nametag","Awarded after completing a Drowsy Dreamland task"),
