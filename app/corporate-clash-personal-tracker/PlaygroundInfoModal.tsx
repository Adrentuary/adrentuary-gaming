...
const PG_DATA: Record<string, PlaygroundData> = {
  TTC: {
    ...
    pgKey: 'TTC',
    emblem: '/icons/playground-emblems/TTC.webp',
    color: '#d86b10',
  ...
  YOTT: {
    ...
    pgKey: 'YOTT',
    emblem: '/icons/playground-emblems/YOTT.webp',
    color: '#9b70cc',
    streetManager: 'Gatekeeper',
    streetManagerImg: '/icons/streets/Ye-Olde-Toontowne/Gatekeeper.webp',
  ...
  BB: {
    ...
    pgKey: 'BB',
    emblem: '/icons/playground-emblems/BB.webp',
    color: '#dc4a14',
